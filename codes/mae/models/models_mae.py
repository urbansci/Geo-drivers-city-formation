...
2. Removed predefined representation dimensions from mae_vit_large_patch16_dec512d8b to allow external parameter control. 
...
class MaskedAutoencoderViT(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=1,
                 ...
                 mlp_ratio=4., norm_layer=nn.LayerNorm, norm_pix_loss=False, final_emb_dim=None):
        super().__init__()
        ...
        # --------------------------------------------------------------------------
        # Add an additional layer to reduce the dimension of the output of encoder. 
        ...
        self.final_emb_dim = final_emb_dim if final_emb_dim is not None else embed_dim
        # --------------------------------------------------------------------------
        # MAE decoder specifics
        self.decoder_embed = nn.Linear(self.final_emb_dim, decoder_embed_dim, bias=True)
